 ...
 *          Разменности матриц тоже считывать с клавиатуры.
 *
 *      @subsection АЛГОРИТМ
 *          Пусть даны 2 матрицы (которые ввел пользователь):
 *          A и B, C — произвадение этих матриц.
 *
 *              A × B =
...
(**
    @fn matrix_write Выводит матрицу matrix размераром nrows, ncolumns на стандартный вывод.
    ...
    *)
    ...
    begin
        ...
        **)
        ...
        begin
            (** 
                Если A и B оказались несовместны, то С мы посчитать не можем.
