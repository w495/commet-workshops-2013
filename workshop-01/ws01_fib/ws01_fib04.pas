(*****************************************************************************
 *
 *  @mainpage Числа Фибоначчи. Рабочая версия. Ввод ограничения с клавиатуры.
 *
 *  @section ОПИСАНИЕ
 *      Выводит на экран числа Фибоначчи с первого по n-тое.
 *
 *      @subsection ЗАДАЧА
 *          Требуется вывести на экран числа Фибоначчи с первого по ы,
 *          в формате
 *              `номер` -> `число`
...
(**
    @var    limit   Количество итераций цикла.
            ...
            limit   ∈ integer = [-32768, 32767];
            integer занимает 2 байта.
            ПРОБЛЕМА:
                Вводимое число не может быть больше 24.
                Из-за ограничения в curr и prev ∈ [1, 32767],
                числа Фибоначчи по номеру больше 24 считаются неправильно:
...
begin
    ...
    **)
    ...
    (**
        ...
        Таким образом мы сдвигаем prev и curr по нашей последомательности.
