(*****************************************************************************
 *
 *  @mainpage Числа Фибоначчи. Рабочая версия. Использование контанты.
 *
 *  @section ОПИСАНИЕ
...
(**
    ...
    В алгоритме переназначение чисел осуществляется LIMIT раз.
    В данной программе LIMIT ≡ 10.
    Выделение всех чисел в программе в константы — правило хорошего тона.
    Огромное преимущество контант в том, что можно их менять,
    от программы к программе не влезая в код алгоритмов.
**)
const LIMIT = 10;
